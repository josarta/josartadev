...
class LandingExportPhp
{
     ...
     * @var string
     */
    private $endpoint = 'https://www.landingiexport.com';
    ...
    private function prepareCurl($hash)
    {
        ...
        if ([] !== $this->proxyConfig) {
            ...
            if ('' !== $proxyAddress && '0' !== $proxyAddress && ('' !== $proxyPort && '0' !== $proxyPort)) {
                curl_setopt($ch, CURLOPT_PROXY, "$proxyAddress:$proxyPort");

                if ('' !== $proxyLogin && '0' !== $proxyLogin && ('' !== $proxyPass && '0' !== $proxyPass)) {
...
const BASE = 'e4a42a6d4cdede8e0d42';
$proxyConfig = [];
$landingHash = null;
